...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wallpost.country'
        db.add_column(u'wall_wallpost', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', null=True, to=orm['Locations.Country']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wallpost.country'
        db.delete_column(u'wall_wallpost', 'country_id')
