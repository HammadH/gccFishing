...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wallpost.city'
        db.add_column(u'wall_wallpost', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', null=True, to=orm['Locations.City']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wallpost.city'
        db.delete_column(u'wall_wallpost', 'city_id')
    ...
    models = {
        ...
        u'wall.comment': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wall.Wallpost']"}),
            'posted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authtools.User']"}),
