...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostVote.votes'
        db.add_column(u'wall_postvote', 'votes',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostVote.votes'
        db.delete_column(u'wall_postvote', 'votes')
    ...
    models = {
        ...
        u'wall.postvote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': u"orm['wall.Wallpost']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': u"orm['authtools.User']"}),
            'votes': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
        u'wall.wallpost': {
