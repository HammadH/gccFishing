...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Wallpost.notify_list'
        db.add_column(u'wall_wallpost', 'notify_list',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Wallpost.notify_list'
        db.delete_column(u'wall_wallpost', 'notify_list')
    ...
    models = {
        ...
        u'wall.wallpost': {
            ...
            'image_3': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'notify_list': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'posted_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
