...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wallpost.image_1'
        db.add_column(u'wall_wallpost', 'image_1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Wallpost.image_2'
        db.add_column(u'wall_wallpost', 'image_2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Wallpost.image_1'
        db.delete_column(u'wall_wallpost', 'image_1')

        # Deleting field 'Wallpost.image_2'
        db.delete_column(u'wall_wallpost', 'image_2')


        # User chose to not deal with backwards NULL issues for 'Wallpost.image'
        raise RuntimeError("Cannot reverse this migration. 'Wallpost.image' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Wallpost.image'
        db.alter_column(u'wall_wallpost', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
