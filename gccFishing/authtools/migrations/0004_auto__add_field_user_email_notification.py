...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.email_notification'
        db.add_column(u'authtools_user', 'email_notification',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.email_notification'
        db.delete_column(u'authtools_user', 'email_notification')
