...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'authtools_user', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'members', to=orm['Locations.City']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'User.country'
        raise RuntimeError("Cannot reverse this migration. 'User.country' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.country'
        db.add_column(u'authtools_user', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'members', to=orm['Locations.Country']),
                      keep_default=False)
