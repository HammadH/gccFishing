...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'onlineuser_online', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='online', unique=True, null=True, to=orm['authtools.User'])),
    ...
    models = {
        ...
        u'onlineuser.online': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'online'", 'unique': 'True', 'null': 'True', 'to': u"orm['authtools.User']"})
        }
    }
